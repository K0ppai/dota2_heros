...
const NavBar = () => (
  <nav className="z-2 py-4 flex items-center justify-around">
    <div className="flex items-center">
      <NavLink to="/">
        <IoCaretBackSharp className="text-gray-400 text-2xl" />
      </NavLink>
      <NavLink to="/">
        <img
    ...
    <NavLink to="https://store.steampowered.com/app/570/Dota_2/" className="hidden w-[20%] border-2 border-x-slate-400 p-3 rounded-md">
